...
#define get_period_params(params) syscall(341, params)
#define set_period_params(period, execution_time, num_of_periods) \
	syscall(342, period, execution_time, num_of_periods)
